...
return [
    ...
    'max'                  => [
        ...
        'string'  => 'يجب أن لا يتجاوز طول النّص:max حرف',
    ],
    ...
    'attributes'           => [
        ...
        'year'                  => 'السنة',
        'employee_img'          => 'الصورة الشخصية',
        'nationality'           => 'الجنسية',
        'nation_num'            => 'الرقم الوطني',
        'birthday'             => 'تاريخ الميلاد',
        'family'               => 'الحالة الاجتماعية',
        'department'            => 'القسم',
        'period'                => 'فترة الدوام',
        'qualification'         => 'المؤهل العلمي',
        'salary'               => 'الراتب الشهري',
        'extra_hour_price'      => 'سعر ساعة الإضافي',
        'finger_num'            => 'الرقم الوظيفي',
        'job'                   => 'الوظيفة',
        'request_date'          => 'تاريخ الطلب',
        'days_num'              => 'عدد أيام الإجازة',
        'start_day'             => 'اليوم',
        'holiday_date'          => 'التاريخ',
        'department_option'     => 'رأي رئيس القسم',
        'hr_option'             => 'رأي الموارد البشرية',
        'request_day'           => 'اليوم',
        'end_hour'              => 'الساعة',
        'start_hour'            => 'الساعة',
        'cv_path'               => 'الملف',
