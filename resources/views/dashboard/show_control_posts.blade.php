...
<body class="bd-gray-100">
    <section dir="rtl">
        <div class="container">
            <div class="row shadow my-4 py-4">
                <div class="col-sm-6">
                    <span class="d-none d-sm-block fs-4 fw-bold text-end">المنشورات</span>
                </div>
                            ...
                            <div class="modal-body">
                                ...
                                <div class="tab-content w-50" id="myTabContent">
                                    ...
                                    <div class="tab-pane fade show active" id="home-tab-pane-{{$post->id}}" role="tabpanel" aria-labelledby="home-tab" tabindex="0">
                                        @foreach($post->likes as $like)
                                        @if($like->like == 1)
                                        <a href="" class="d-flex flex-row text-decoration-none link-secondary mt-3">
                            ...
                            <div class="d-flex flex-column">
                                <span class="mb-1 align-self-end">
                                    ...
                                    <span href="#" title="إزالته من المناشير المميزة" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-title="إزالته من المناشير المميزة">
                                        <button type="button" class="p-0 bd-gray-100 border-0" value="{{$post->id}}">
                                            <i class="fa-solid fa-heart-circle-check" id="heart_icon-{{$post->id}}"></i></button>
                                    </span> &nbsp;&nbsp;&nbsp;&nbsp;
                                    @else
                                    <span href="#" title="جعله مميز" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-title="جعله مميز">
                                        <button type="button" class="p-0 bd-gray-100 border-0" value="{{$post->id}}" id="heart">
                                            <i class="fa-solid fa-heart" id="heart_icon-{{$post->id}}"></i></button>
                                    </span> &nbsp;&nbsp;&nbsp;&nbsp;
                                    @endif
    ...
    <div class="row my-4">
        <div class="col-12 d-flex align-itmes-center justify-content-center">
            {{ $posts->links("pagination::bootstrap-4") }}
        </div>
    </div>
    <!-- كود الاعجاب وعدم الاعجاب -->
    <script>
        document.querySelectorAll(".nav_link")[1].classList.add("myactive");
        ...
        function myFunction(y) {
            y.classList.toggle("fa-heart-circle-check");
        }
        // حعله مميز
        $(document).ready(function() {
            $.ajaxSetup({
            ...
            $(document).on('click', '#heart', function() {
                ...
                $.ajax({
                    type: "post",
                    url: "/make_featured_post",
                    data: {
                        'post_id': post_id,
                    },
                    success: function(res) {
                        if (res.status == 200) {
                            document.getElementById("heart_icon-"+post_id).classList.toggle("fa-heart-circle-check");
                            document.getElementById("heart").setAttribute("id", " ");
                            alert("تم تصنيف المنشور ضمن المناشير المميزة");
                        } else {
                            alert(res.status);
                        }
                    }
