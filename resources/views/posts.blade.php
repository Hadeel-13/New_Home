...
<body class="bd-gray-100">
    ...
    <section class="container">
        <div class="row" dir="rtl">
            <div class="col-12">
                <div class="fs-2 fw-bold my-3 text-center">أقسام المنشورات</div>
                <nav>
                    <div class="nav nav-tabs" id="nav-tab" role="tablist">
                        <button class="nav-link active" id="nav-home-tab" data-bs-toggle="tab" data-bs-target="#nav-home" type="button" role="tab" aria-controls="nav-home" aria-selected="true">بيع</button>
                        <button class="nav-link" id="nav-profile-tab" data-bs-toggle="tab" data-bs-target="#nav-profile" type="button" role="tab" aria-controls="nav-profile" aria-selected="false">آجار</button>
                        <button class="nav-link" id="nav-contact-tab" data-bs-toggle="tab" data-bs-target="#nav-contact" type="button" role="tab" aria-controls="nav-contact" aria-selected="false">رهن</button>
                        <button class="nav-link" id="nav-contact-tab" data-bs-toggle="tab" data-bs-target="#nav-else" type="button" role="tab" aria-controls="nav-else" aria-selected="false">أخرى</button>
                ...
                <div class="tab-content" id="nav-tabContent">
                    <div class="tab-pane fade mb-4 show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab" tabindex="0">
                        <div class="row row-cols-1 row-cols-sm-1 row-cols-md-2 row-cols-lg-3 row-cols-xl-4 g-4 mt-3" dir="rtl">
                            ...
                            <div class="d-flex flex-column align-items-center">
                                <img src="../Images/svg/illustrations/No-data-cuate.svg" width="450px" height="350px">
                                <p class="d-block text-dark fs-5 placeholder">لا يوجد مناشير</p>
                            </div>
                            @endforelse
                    ...
                    <div class="tab-pane fade mb-4" id="nav-contact" role="tabpanel" aria-labelledby="nav-contact-tab" tabindex="0">
                        <div class="row row-cols-1 row-cols-sm-1 row-cols-md-2 row-cols-lg-3 row-cols-xl-4 g-4 mt-3" dir="rtl">
                            @forelse($mort_posts as $post)
                            @foreach($post->comments as $comment)
                            <!-- Modal edit comment-->
                            <div class="modal fade editModal" id="editcomment-{{$comment->id}}" aria-hidden="true" aria-labelledby="editcomment" tabindex="-1" dir="rtl">
                                <div class="modal-dialog modal-md modal-fullscreen-lg-down modal-dialog-centered modal-dialog-scrollable">
                    ...
                    <div class="tab-pane fade mb-4" id="nav-else" role="tabpanel" aria-labelledby="nav-else-tab" tabindex="0">
                        <div class="row row-cols-1 row-cols-sm-1 row-cols-md-2 row-cols-lg-3 row-cols-xl-4 g-4 mt-3" dir="rtl">

                            @forelse($else_posts as $post)
                            @foreach($post->comments as $comment)
                            <!-- Modal edit comment-->
                            <div class="modal fade editModal" id="editcomment-{{$comment->id}}" aria-hidden="true" aria-labelledby="editcomment" tabindex="-1" dir="rtl">
                                <div class="modal-dialog modal-md modal-fullscreen-lg-down modal-dialog-centered modal-dialog-scrollable">
                            ...
                            @empty
                            <!-- no comments -->
                            <div class="image-comment d-flex flex-column align-items-center">
                                <img src="../Images/svg/illustrations/No-data-cuate.svg" width="450px" height="350px">
                                <p class="d-block text-dark fs-5 placeholder">لا يوجد مناشير</p>
                            </div>
                            @endforelse
    ...
    <!-- <script src="libraries/MDB-Free_4.20.0/js/mdb.min.js"></script> -->
    <script>
        ...
        $(".like").on('click', function() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    // alert(post_id);
                    if (data.is_like == 1) {
                        $('*[data-post_id="' + post_id + '_l"]').removeClass('secondary').addClass('text-purple');
                        $('*[data-post_id="' + post_id + '_d"]').removeClass('text-purple').addClass('secondary');
                    ...
                    if (data.is_like == 0) {
                        $('*[data-post_id="' + post_id + '_l"]').removeClass('text-purple').addClass('secondary');
                        var cu_like = $('*[data-post_id="' + post_id + '_l"]').find('.like_count').text();
                        var new_like = parseInt(cu_like) - 1;
                        var cu_like = $('*[data-post_id="' + post_id + '_l"]').find('.like_count').text(new_like);
                    }
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (data.is_dislike == 1) {
                        $('*[data-post_id="' + post_id + '_d"]').removeClass('secondary').addClass('text-purple');
                        $('*[data-post_id="' + post_id + '_l"]').removeClass('text-purple').addClass('secondary');
                        var cu_dislike = $('*[data-post_id="' + post_id + '_d"]').find('.dislike_count').text();
                        var new_dislike = parseInt(cu_dislike) + 1;
                        $('*[data-post_id="' + post_id + '_d"]').find('.dislike_count').text(new_dislike);
