            ...
            <div class="tab col-12 placeholder-glow">
                ...
                <div class="row mb-2">
                    <div class="col-md-6">
                        ...
                        <select class="form-select mb-4 placeholder" aria-label="Default select example"
                            class="form-select" id="realEstateType" oninput=" this.className = 'form-select mb-4' "
                            required>
                ...
                <div class="row  mb-2">
                    ...
                    <div class="form-check mb-2 col-sm-4">
                        <input class="form-check-input placeholder" type="checkbox" value="1" id="flexCheckChecked_D1"
                            style="margin-left: 0; float: none;" required>
                        <label class="form-check-label placeholder" for="flexCheckChecked_D1">بيع </label>
                    </div>
                    <div class="form-check mb-2 col-sm-4">
                        <input class="form-check-input placeholder" type="checkbox" value="2" id="flexCheckChecked_D2"
                            style="margin-left: 0; float: none;">
                        <label class="form-check-label placeholder" for="flexCheckChecked_D2"> آجار</label>
                    </div>
                    <div class="form-check mb-2 col-sm-4">
                        <input class="form-check-input placeholder" type="checkbox" value="4" id="flexCheckChecked_D3"
                            style="margin-left: 0; float: none;">
                        <label class="form-check-label placeholder" for="flexCheckChecked_D3">رهن</label>
                    </div>
                    <input type="hidden" id="Departement-value" />
                </div>
                <div class="row  mb-2">
                    <div class="col-12">
                        <div class="alert alert-danger alert-dismissible fade show d-none"
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-2" id="inputFloor-s">
                        ...
                        <div class="input-group mb-3">
							...
							return(event.charCode>=48 && event.charCode<=57)" required>
            ...
            <div class="tab col-12">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control rounded-0" id="youtubeLinkInput" required>
                ...
                <div class="row">
                    <div class="col-12 mb-3 mx-auto">
                        <iframe id="YTVideo" class="d-none" width="100%" height="250px"
