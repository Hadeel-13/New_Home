...
document.getElementById("realEstateType").onblur = function () {
    if (
        ...
        document.getElementById("Features-value").value = "noDetails";
        return;
    }
    ...
    document.getElementById("Features-value").value = "";
...
function showTab(n) {
    ...
    if (n == x.length - 2) {
        ...
        document.getElementById("nextBtn").innerHTML = "جاري الإرسال";
    } else {
...
function calculateFeaturesIn() {
    ...
    document.getElementById("Features-value").value = Features_value;
    return true;
}
